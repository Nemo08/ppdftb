...
func Run(ctx context.Context, cfg *Config) error {
	...
	// Данные штампа (XML) для содержания берём с фиксированным уровнем поиска 1
	// (rootDir + один родитель), в отличие от основного прохода wconv, где уровень
	// задаётся флагом -u (cfg.XMLDepth). Считаем один раз:
